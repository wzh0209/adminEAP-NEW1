...
public class AqFilesTaskCompleteListener2 implements TaskListener{
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        if(EVENTNAME_COMPLETE.equals(eventName)){
             ...
             //10=新建,20=总经理审核,30=审核完成,40=驳回,60=项目经理审核，70=总工审核，80=工程科审核
             if (FALSE.equalsIgnoreCase(delegateTask.getVariable("approved").toString())) {
            	 ...
            	 if ("zg2".equals(taskDefinitionKey)) {///总工审
            		 zf.setStatus("30");
            	 }else if("xmjl2".equals(taskDefinitionKey)){//项目经理
            		 zf.setStatus("80");
            	 }else if("gck2".equals(taskDefinitionKey)){//工程科
            		 zf.setStatus("70");
            	 }
             }
