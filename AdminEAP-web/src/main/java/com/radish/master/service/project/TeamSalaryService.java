...
public interface TeamSalaryService extends BaseService {
    ...
    Result startElseSalaryFlow(Salary salary, String processDefinitionKey);
    ...
    void handleSocialSalaryDetailPayable(SocialSecurity socialSecurity, SalaryDetail detail, Date startDate);
